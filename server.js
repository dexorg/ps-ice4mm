...
configFactory.get(environment, myConfig, function (err, config) {
    ...
    app.use('/campaign-dynamic',require('./routes/routes-dynamic-campaign-allocator')(config, appApiAuth));


    app.use('/plan-diagram',require('./routes/routes-plan-diagram')(config, appApiAuth));
